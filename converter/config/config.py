...
class Config:
    ...
    ACC_TRANSFORMATION_PATH = f"{TRANSFORMATIONS_PATH}.{ACC_TRANSFORMATION_LABEL}"
    LOC_TRANSFORMATION_LABEL = "loc"
    LOC_TRANSFORMATION_PATH = f"{TRANSFORMATIONS_PATH}.{LOC_TRANSFORMATION_LABEL}"
    RI_TRANSFORMATION_LABEL = "ri"
    RI_TRANSFORMATION_PATH = f"{TRANSFORMATIONS_PATH}.{RI_TRANSFORMATION_LABEL}"
